...
describe("makeLinkedList", () => {
  ...
  // describe("when adding values through append fn...", () => {
  //   it("should contain correct values", () => {
  //     const linkedList = makeLinkedList<string>();
  //     linkedList.append("0");
  //     linkedList.append("1");
  //     const fn = jest.fn();
  ...
  //   it("should contain correct number of values", () => {
  //     const linkedList = makeLinkedList<string>();
  //     linkedList.appendValue("0");
  //     linkedList.appendValue("1");
  //     const fn = jest.fn();
  //     for (const item of linkedList.values()) {
  //       fn(item);
  //     }
  //     expect(fn).toBeCalledTimes(2);
  //   });
  ...
  //   const linkedList = makeLinkedList(sampleValue);
  //   const fn = jest.fn();
  //   for (const item of linkedList.values()) {
  //     fn(item);
  //   }
  //   expect(fn).toBeCalledWith(sampleValue);
  // });

  // it("should append nodes correctly", () => {
  //   const linkedList1 = makeLinkedList("0", "1");
  //   const linkedList2 = makeLinkedList("2", "3");
  //   linkedList1.appendNode(linkedList2.getHead());
  //   const fn = jest.fn();
  //   for (const item of linkedList1.values()) {
  //     fn(item);
  //   }
  //   expect(fn).toBeCalledWith("0");
  //   expect(fn).toBeCalledWith("1");
